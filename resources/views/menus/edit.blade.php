...
<div class="d-flex justify-content-center col-12">
    ...
    <div class="col-10">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="description" id="description" cols="30" rows="10" placeholder="Insira as informações da refeição" required >{{ old('description') ?? $menu -> description }}</textarea>
        </div>
